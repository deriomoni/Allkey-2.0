...
# Аванс 4 500 перечислен раньше акта, акт подписан на 4 000. Начисленную
# часть движок выводит сам из двух сумм — отдельного ответа «начислено 4 000»
# больше нет: это был ярлык состояния. 500 остаются незакрытыми.
PPP_ME = row(**{
    "S2.3": "OFF54", "S5.1": RENT, "S5.5": "rent_vehicle", "S6.1": OUTSIDE_KZ,
    "S7.2": "no", "S1.5": "EUR", "S4.4": 4000.0, "S4.5": 594.50,
    "S4.1": M3, "S4.2": date(2026, 3, 10),
