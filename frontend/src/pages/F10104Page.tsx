          ...
          <>
            ...
            <Radio
              ...
              hint={'С 1 января 2026 года НДС за нерезидента платит только покупатель, состоящий '
                + 'на регистрационном учёте по НДС (ст. 454 п. 1 НК РК). До 2026 года обязанность '
                + 'возникала у любого налогоплательщика РК — это изменилось.'}
            />
            ...
            {answers['S5.1'] === 'goods' && (
              <>
                <Radio
                  ...
                  hint="Сама поставка товара доходом из источников в РК не признаётся."
                />
                <Radio
